                ...
                <tbody>
                     <tr className="border-b border-gray-200 dark:border-gray-700">
                        ...
                        <td className="px-6 py-4 text-black bg-blue-900">
                            <div className={`font-bold text-white ${classNames(styles.value)}`}>1.33606</div>
                        </td>
                    </tr>
                    <tr className="border-b border-gray-200 dark:border-gray-700">
                        <th scope="row" className={`px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-gray-100 dark:text-white dark:bg-gray-800 ${classNames(styles.table_head)}`}>
                            <div className={`${classNames(styles.descrption)}`}>Stop Loss (pips) <span className="text-xs font-light text-purple-600">(( Stop Loss Price - Entry Price) / Pips Conversion)</span></div>
                        </th>
